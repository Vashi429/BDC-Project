            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="card-header-form">
                        ...
                        <a class="btn btn-primary text-right mr-2" href="<?= base_url() ?>/admin/bill/exportCSV">Export Bill</a>

                        <a class="btn btn-primary text-right" href="<?= base_url() ?>/admin/bill/addBill">Add Bill</a>
                ...
                <div class="card-body p-0">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped" id="viewBill">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th><a href="javascript:void(0);" field="bd.date" class="_sort">Date</a></th>

                                    <th><a href="javascript:void(0);" field="b.int_glcode" class="_sort">Id</a></th>

                                    <th><a href="javascript:void(0);" field="b.var_bill_id" class="_sort">Bill Id</a></th>
                                    ...
                                    <th><a href="javascript:void(0);" field="s.var_name" class="_sort">Profile Name</a></th>

                                    <th><a href="javascript:void(0);" field="bd.var_amount" class="_sort">Bill Amount</a></th>

                                    <th><a href="javascript:void(0);" field="bd.var_due_amount" class="_sort">Bill Due Amount</a></th>

                                    <th><a href="javascript:void(0);" field="bd.status" class="_sort">Status</a></th>

                                    <th><a href="javascript:void(0);">Option</a></th>
                                ...
                                <?php if(!empty($data)){
                                    ...
                                    foreach ($data as $key => $value) { ?>
                                        ...
                                        <tr id="<?= $value['int_glcode'] ?>">
                                            ...
                                            <td><a href="<?= base_url() ?>/admin/bill/editBill/<?= base64_encode($value['int_glcode']) ?>"><?= $value['int_glcode']?></a></td>
                                            ...
                                            <?php if($value['var_due_amount'] == '0'){ ?>
                                                <td><div class="badge badge-success">Paid</div></td>
                                            <?php } else if($value['var_amount'] == $value['var_due_amount']){ ?>
                                                <td><div class="badge badge-danger">Unpaid</div></td>
                                            <?php } else { ?>
                                                <td><div class="badge badge-warning">Partial Paid</div></td>
                                            <?php } ?>
                                            ...
                                            <td>
                                                <div class="dropdown d-inline">
                                                    ...
                                                    <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 28px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                        <a  class="dropdown-item has-icon" href="<?= base_url() ?>/admin/bill/list_bill_expens/<?= base64_encode($value['int_glcode']) ?>"><i class="fa fa-eye"></i> View Payment List</a>
                                                    </div>
                                                </div>
                                            </td>

                                            <!-- <td style="width: 12%;"><?= date('d-m-Y',strtotime($value['dt_createddate'])); ?></td> -->
                                        </tr>
                ...
                <input type="hidden" name="hfield" value="b.int_glcode">

                <input type="hidden" name="hsort" value="desc">

                <input type="hidden" name="hpageno" value="0">

                <input type="hidden" name="module" id="module" value="bill">
...
<script src= "<?= base_url() ?>/public/assets/dist/js/bill.js"></script>
