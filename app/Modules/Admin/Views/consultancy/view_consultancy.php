        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"  aria-current="page">View Consultancy</li>
                </ol>
            </nav>
        </div>
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Consultancy Management</h4>
                    <div class="card-header-form">
                        <a class="btn btn-primary text-right mr-2" href="<?= base_url() ?>/admin/consultancy/exportCSV">Export Consultancy</a>
                        <a class="btn btn-primary text-right" href="<?= base_url() ?>/admin/consultancy/addConsultancy">Add Consultancy</a>
                    </div>
                </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-striped" id="viewConsultancy">
                            <thead>
                                <tr>
                                ...
                                <?php if(!empty($data)){
                                    foreach ($data as $key => $value) { 
                                        ...
                                        <tr id="<?= $value['int_glcode'] ?>">
                                            ...
                                            <td><a href="<?= base_url() ?>/admin/consultancy/editConsultancy/<?= base64_encode($value['int_glcode']) ?>"><?=$value['int_glcode']?></a></td>
                                            ...
                                            <td class="text-center">
                                                <a href="javascript:void(0);">
                                                    <img id="tick-<?php echo $value['int_glcode']; ?>" height="16" width="16" alt="<?php echo $title; ?>" title="<?php echo $title; ?>" src="<?php echo base_url() . '/public/assets/site_imges/' . $tickimg; ?>" style="vertical-align:middle;cursor:pointer;" onclick="UpdatePublish('consultancy', 'mst_consultancy', 'chr_publish', '<?php echo $update_val; ?>', '<?php echo $value['int_glcode']; ?>');">
                                                </a>
                                            </td>
                                        </tr>
                                    <?php }
                ...
                <input type="hidden" name="module" id="module" value="consultancy">
...
<script src= "<?= base_url() ?>/public/assets/dist/js/consultancy.js"></script>
