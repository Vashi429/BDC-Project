		...
		<div class="col-12">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb p-0">
					...
					<li class="breadcrumb-item">Add Received Payment</li>
				</ol>
			</nav>
		</div>
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h4>Create Received Payment</h4>
					<p class="mb-0 text-muted tx-13"></p>
				</div>
				<div class="card-body">
				    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" onclick="paymentTypeTab('IP')" id="invoice-tab" data-toggle="tab" href="#invoice" role="tab"
                          aria-controls="invoice" aria-selected="true">Invoice Payment</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" onclick="paymentTypeTab('CA')" id="advance-tab" data-toggle="tab" href="#advance" role="tab"
                          aria-controls="advance" aria-selected="false">Customer Advance</a>
                      </li>
                    </ul>
                      ...
                      <div class="tab-pane fade show active" id="invoice" role="tabpanel" aria-labelledby="invoice-tab">
                        <form action="javascript:void(0)" id="ReceivedInvoice" enctype="multipart/form-data" method="POST">
    						...
    						<div class="form-group row">
    							...
    							<div class="col-sm-9 col-lg-4">
    								<input type="text" readonly name="var_received_id" id="var_received_id" class="form-control" value="<?= $autoReceivedID ?>" required>
    							</div>
    						</div>
    						<div class="form-group row">
...
<script>
	...
	$(document).on('submit','#ReceivedInvoice', function (e) {
		...
		return false;
			...
			$.ajax({
				type: 'post',
				url: sitepath+'/admin/receivedPayment/insertRecord',
