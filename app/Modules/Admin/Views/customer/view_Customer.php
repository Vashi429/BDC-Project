            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-form">
                        <a class="btn btn-primary text-right mr-2" href="<?= base_url() ?>/admin/customer/exportCSV">Export Customers</a>
                        <a class="btn btn-primary text-right" href="<?= base_url() ?>/admin/customer/addCustomer">Add Customer</a>
                    </div>
                </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-striped" id="viewCustomer">
                            <thead>
                                <tr>
                                    ...
                                    <th><a href="javascript:void(0);" field="var_displayname" class="_sort">Display Name</a></th>
                                ...
                                <?php if(!empty($data)){
                                    foreach ($data as $key => $value) { 
                                        ...
                                        <tr id="<?= $value['int_glcode'] ?>">
                                            ...
                                            <td><a href="<?= base_url() ?>/admin/customer/editCustomer/<?= base64_encode($value['int_glcode']) ?>"><?=$value['int_glcode']?></a></td>
                                            <td><?=$value['var_name']?></td>
                                            <td><?=$value['var_displayname']?></td>
                                            <td><?=$value['var_email']?></td>
                                            <td><?=$value['var_phone']?></td>
                                            <td><?=$value['var_customer_type']?></td>
...
<script src= "<?= base_url() ?>/public/assets/dist/js/customer.js"></script>
