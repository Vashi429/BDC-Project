<main>
    ...
    <section class="pt-5 pb-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 pt-4 pb-4 pe-lg-5">
                    <h2 class="mb-3"><?= lang('Blog.aboutUsSection1Heading') ?></h2>
                    <p><?= lang('Blog.aboutUsSection1para1') ?></p>
                    <p><?= lang('Blog.aboutUsSection1para2') ?></p>
                    <div class="mt-5">
                        <div class="button-group"> <a href="#" class="btn btn-primary me-4"><?= lang('Blog.aboutUsBtnGetQuoteNow') ?></a> <a href="#" class="btn btn-outline"><?= lang('Blog.aboutUsBtnLearnMore') ?></a> </div>
                    </div>
                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card p-4">
                                    <div class="card-body p-2">
                                        <div class="icon_title d-flex align-items-center mb-4"> <img src="<?= base_url(); ?>/public/front_assets/images/icn_resize.svg" alt="slider-img">
                                            <h4><?= lang('Blog.aboutUsSlider1Heading1') ?></h4>
                                        </div>
                                        <p class="m-0"><?= lang('Blog.aboutUsSlider1para1') ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="card p-4">
                                    <div class="card-body p-2">
                                        ...
                                        <p class="m-0"><?= lang('Blog.aboutUsSlider2para2') ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="card p-4">
                                    <div class="card-body p-2">
                                        ...
                                        <p class="m-0"><?= lang('Blog.aboutUsSlider3para3') ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="card p-4">
                                    <div class="card-body p-2">
                                        ...
                                        <p class="m-0"><?= lang('Blog.aboutUsSlider4para4') ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="card p-4">
                                    <div class="card-body p-2">
                                        ...
                                        <p class="m-0"><?= lang('Blog.aboutUsSlider5para5') ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 pt-4 pb-4">
                    ...
                    <p><?= lang('Blog.aboutUsSection2para1') ?></p> <span><strong><?= lang('Blog.aboutUsSection2Strong') ?></strong></span>
                </div>
            </div>
        </div>
    </section>
